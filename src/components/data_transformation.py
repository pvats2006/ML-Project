...
# Builds preprocessing pipeline (imputation, encoding, scaling), applies it on train/test data,
# prevents data leakage, converts data into model-ready arrays, and saves the preprocessor for future use.